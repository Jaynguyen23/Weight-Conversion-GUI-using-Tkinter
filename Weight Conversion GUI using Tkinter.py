...
e1 = tkinter.Label(window, text = "Enter the weight in Kg")
e2_value = tkinter.StringVar()
e2 = tkinter.Entry(window, textvariable = e2_value)
e3 = tkinter.Label(window, text = 'Gram')
e4 = tkinter.Label(window, text = 'Pounds')
e5 = tkinter.Label(window, text = 'Ounce')
...
b1 = tkinter.Button(window, text = "Convert", command = from_kg)
